...
modifiedTime: "2024-07-29 14:17:45"
---
...
- [@fos/prettier-config](http://114.67.207.142:31585/-/web/detail/@fos/prettier-config)
- [@fos/eslint-config](http://114.67.207.142:31585/-/web/detail/@fos/eslint-config)
- [@fos/stylelint-config](http://114.67.207.142:31585/-/web/detail/@fos/stylelint-config)
...
```shell
pnpm i @fos/prettier-config prettier -D
```
...
```js
// .prettierrc.js
const FosPrettierConfig = require("@fos/prettier-config");
