...
export default function Header() {
  ...
  return (
    <div className="sticky left-0 top-0 z-10 flex h-14 w-full cursor-pointer items-center justify-between px-6 shadow shadow-slate-200 backdrop-blur lg:px-32 dark:shadow-slate-800">
      <motion.div
